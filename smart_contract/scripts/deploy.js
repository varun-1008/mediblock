...
async function main() {
    ...
    const mappingContractPatientAddress =
    ...
    const mappingContractDoctorAddress =
        await mappingContractDoctor.getAddress();

    const mediblockContractFactory = await ethers.getContractFactory("MediBlock", {
        libraries: {
            IterableMappingPatient: mappingContractPatientAddress,
            IterableMappingDoctor: mappingContractDoctorAddress,
        },
    });
